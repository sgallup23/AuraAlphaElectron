import{r as l,j as e}from"./vendor-CL9TIcsc.js";import C from"./PublicNav-ClirSp5P.js";import T from"./PublicFooter-DjbxbjvL.js";import{A as B}from"./AuraLogo-Bvcaswi_.js";import{u as I}from"./usePageTitle-B3ORw3CT.js";import{f as P}from"./pricing-CUA1-L4b.js";import{P as d}from"./index-n6reJo2y.js";import"./i18n-D77-lTfE.js";import"./motion-P4m0MKnO.js";import"./radix-BX0blWs4.js";const _="_page_1r8wr_4",E="_hero_1r8wr_11",x="_heroLogoWrap_1r8wr_18",R="_heroTitle_1r8wr_22",q="_heroSub_1r8wr_29",N="_contentWrap_1r8wr_37",L="_sidebar_1r8wr_47",G="_sidebarBtn_1r8wr_54",M="_sidebarBtnActive_1r8wr_74 _sidebarBtn_1r8wr_54",O="_contentArea_1r8wr_86",K="_sectionTitle_1r8wr_91",j="_docCard_1r8wr_102",D="_docCardHeader_1r8wr_110",F="_docCardTitle_1r8wr_122",V="_docCardChevron_1r8wr_128",W="_docCardChevronOpen_1r8wr_134 _docCardChevron_1r8wr_128",U="_docCardBody_1r8wr_139",H="_docCardBodyContent_1r8wr_143",Y="_ctaSection_1r8wr_154",$="_ctaTitle_1r8wr_160",z="_ctaSub_1r8wr_167",Q="_ctaLink_1r8wr_173",X="_faqSearchWrap_1r8wr_189",Z="_faqSearchIcon_1r8wr_200",J="_faqSearch_1r8wr_189",ee="_faqSearchClear_1r8wr_220",te="_faqNoResults_1r8wr_234",ae="_mobileNavToggle_1r8wr_242",oe="_mobileNavBtn_1r8wr_250",re="_mobileNavChevron_1r8wr_267",se="_mobileNavDropdown_1r8wr_273",ie="_mobileNavItem_1r8wr_286",ne="_mobileNavItemActive_1r8wr_306 _mobileNavItem_1r8wr_286",t={page:_,hero:E,heroLogoWrap:x,heroTitle:R,heroSub:q,contentWrap:N,sidebar:L,sidebarBtn:G,sidebarBtnActive:M,contentArea:O,sectionTitle:K,docCard:j,docCardHeader:D,docCardTitle:F,docCardChevron:V,docCardChevronOpen:W,docCardBody:U,docCardBodyContent:H,ctaSection:Y,ctaTitle:$,ctaSub:z,ctaLink:Q,faqSearchWrap:X,faqSearchIcon:Z,faqSearch:J,faqSearchClear:ee,faqNoResults:te,mobileNavToggle:ae,mobileNavBtn:oe,mobileNavChevron:re,mobileNavDropdown:se,mobileNavItem:ie,mobileNavItemActive:ne},c=[{id:"getting-started",title:"Getting Started",icon:"&#128640;",items:[{title:"What Is Aura Alpha?",content:`Aura Alpha is a multi-bot, risk-siloed algorithmic trading platform. It runs unlimited independent trading bots against ${d.strategies} pre-built strategies across US equities and crypto markets.
...
• Signal Validation — Every signal is logged with a UUID, confidence score, and backtest stats.`},{title:"Create Your Account",content:P},{title:"Connect Interactive Brokers (IBKR)",content:`IBKR is the primary broker for equity trading. We never see your IBKR password — only the API connection you authorize through your local IB Gateway.
...
The dashboard auto-refreshes every 30 seconds. Kill switch and portfolio brain panels update every 5 seconds.`}]},{id:"strategies",title:"Strategies",icon:"&#9881;",items:[{title:`The ${d.strategies}-Strategy Catalogue`,content:`Aura Alpha includes ${d.strategies} pre-built strategies in its catalogue:
...
• Crypto — crypto 24/7 (AI scoring)`},{title:"Data Stack",content:`• Parquet files — OHLCV data stored as Polars-compatible parquet
  - 500+ US symbols (3 tiers), ${d.regions} regions
...
3 AM UTC daily — PostgreSQL backup (ops/backup_db.sh)`}]}],S=[{q:"Why isn't my bot trading?",a:`Work through the 7-layer safety checklist:
...
• Active: US + 7 regions
• Pro / Elite: All ${d.regions} regions

Regions: US, UK (LSE), Germany (Xetra), Japan (TSE), Hong Kong (HKEX), Canada (TSX), India (BSE), and more.
...
Your data is retained for 90 days after cancellation. After 90 days, it is permanently deleted. Reactivating within 90 days restores all data.`}];function fe(){var f,w;I("Documentation");const[r,k]=l.useState("getting-started"),[u,A]=l.useState({}),[n,h]=l.useState(""),[m,g]=l.useState(!1),y=(a,o)=>{const s=`${a}-${o}`;A(i=>({...i,[s]:!i[s]}))},b=l.useMemo(()=>{if(!n.trim())return S;const a=n.toLowerCase();return S.filter(o=>o.q.toLowerCase().includes(a)||o.a.toLowerCase().includes(a))},[n]),p=a=>{k(a),g(!1),window.scrollTo({top:0,behavior:"smooth"})};return e.jsxs("div",{className:t.page,children:[e.jsx(C,{}),e.jsxs("section",{className:t.hero,children:[e.jsx("div",{className:t.heroLogoWrap,children:e.jsx(B,{variant:"icon",height:64,glow:!0})}),e.jsx("h1",{className:t.heroTitle,children:"Documentation"}),e.jsx("p",{className:t.heroSub,children:"Everything you need to set up, configure, and trade with Aura Alpha."})]}),e.jsxs("div",{className:t.mobileNavToggle,children:[e.jsxs("button",{className:t.mobileNavBtn,onClick:()=>g(a=>!a),children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:((f=c.find(a=>a.id===r))==null?void 0:f.icon)||"&#128640;"}}),(w=c.find(a=>a.id===r))==null?void 0:w.title,e.jsx("span",{className:t.mobileNavChevron,children:m?"▲":"▼"})]}),m&&e.jsxs("div",{className:t.mobileNavDropdown,children:[c.map(a=>e.jsxs("button",{onClick:()=>p(a.id),className:r===a.id?t.mobileNavItemActive:t.mobileNavItem,children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:a.icon}}),a.title]},a.id)),e.jsxs("button",{onClick:()=>p("faq"),className:r==="faq"?t.mobileNavItemActive:t.mobileNavItem,children:[e.jsx("span",{children:"❓"})," FAQ"]})]})]}),e.jsxs("div",{className:t.contentWrap,children:[e.jsxs("nav",{className:t.sidebar,children:[c.map(a=>e.jsxs("button",{onClick:()=>p(a.id),className:r===a.id?t.sidebarBtnActive:t.sidebarBtn,children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:a.icon}}),a.title]},a.id)),e.jsxs("button",{onClick:()=>p("faq"),className:r==="faq"?t.sidebarBtnActive:t.sidebarBtn,children:[e.jsx("span",{children:"❓"}),"FAQ"]})]}),e.jsxs("div",{className:t.contentArea,children:[r!=="faq"&&c.filter(a=>a.id===r).map(a=>e.jsxs("div",{children:[e.jsxs("h2",{className:t.sectionTitle,children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:a.icon}}),a.title]}),(a.items||[]).map((o,s)=>{const i=`${a.id}-${s}`,v=u[i]!==!1;return e.jsxs("div",{className:t.docCard,children:[e.jsxs("button",{onClick:()=>y(a.id,s),className:t.docCardHeader,children:[e.jsx("span",{className:t.docCardTitle,children:o.title}),e.jsx("span",{className:v?t.docCardChevronOpen:t.docCardChevron,children:"▼"})]}),v&&e.jsx("div",{className:t.docCardBody,style:{borderTop:"1px solid rgba(255,255,255,0.03)"},children:e.jsx("pre",{className:t.docCardBodyContent,children:o.content})})]},s)})]},a.id)),r==="faq"&&e.jsxs("div",{children:[e.jsxs("h2",{className:t.sectionTitle,children:[e.jsx("span",{children:"❓"}),"Frequently Asked Questions"]}),e.jsxs("div",{className:t.faqSearchWrap,children:[e.jsx("span",{className:t.faqSearchIcon,children:"🔍"}),e.jsx("input",{className:t.faqSearch,type:"text",placeholder:"Search questions...",value:n,onChange:a=>h(a.target.value)}),n&&e.jsx("button",{className:t.faqSearchClear,onClick:()=>h(""),children:"✕"})]}),b.length===0&&e.jsxs("div",{className:t.faqNoResults,children:['No questions found for "',n,'"']}),b.map((a,o)=>{const s=`faq-${o}`,i=u[s]!==!1;return e.jsxs("div",{className:t.docCard,children:[e.jsxs("button",{onClick:()=>y("faq",o),className:t.docCardHeader,children:[e.jsx("span",{className:t.docCardTitle,children:a.q}),e.jsx("span",{className:i?t.docCardChevronOpen:t.docCardChevron,children:"▼"})]}),i&&e.jsx("div",{className:t.docCardBody,style:{borderTop:"1px solid rgba(255,255,255,0.03)"},children:e.jsx("pre",{className:t.docCardBodyContent,children:a.a})})]},o)})]})]})]}),e.jsxs("section",{className:t.ctaSection,children:[e.jsx("h2",{className:t.ctaTitle,children:"Need Help?"}),e.jsx("p",{className:t.ctaSub,children:"Can't find what you're looking for? Reach out to our team."}),e.jsx("a",{href:"mailto:support@auraalpha.cc",className:t.ctaLink,children:"Contact Support"})]}),e.jsx(T,{})]})}export{fe as default};
