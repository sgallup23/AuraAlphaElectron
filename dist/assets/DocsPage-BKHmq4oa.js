...
4. Ensure AllowBlindTrading=yes in ~/.TWS/jts.ini (Linux) or C:\\Jts\\jts.ini (Windows).
...
Your data is retained for 90 days after cancellation. After 90 days, it is permanently deleted. Reactivating within 90 days restores all data.`}];function he(){var b,f;B("Documentation");const[r,S]=l.useState("getting-started"),[p,k]=l.useState({}),[n,u]=l.useState(""),[h,m]=l.useState(!1),g=(a,o)=>{const i=`${a}-${o}`;k(s=>({...s,[i]:!s[i]}))},y=l.useMemo(()=>{if(!n.trim())return w;const a=n.toLowerCase();return w.filter(o=>o.q.toLowerCase().includes(a)||o.a.toLowerCase().includes(a))},[n]),d=a=>{S(a),m(!1),window.scrollTo({top:0,behavior:"smooth"})};return e.jsxs("div",{className:t.page,children:[e.jsx(A,{}),e.jsxs("section",{className:t.hero,children:[e.jsx("div",{className:t.heroLogoWrap,children:e.jsx(T,{variant:"icon",height:64,glow:!0})}),e.jsx("h1",{className:t.heroTitle,children:"Documentation"}),e.jsx("p",{className:t.heroSub,children:"Everything you need to set up, configure, and trade with Aura Alpha."})]}),e.jsxs("div",{className:t.mobileNavToggle,children:[e.jsxs("button",{className:t.mobileNavBtn,onClick:()=>m(a=>!a),children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:((b=c.find(a=>a.id===r))==null?void 0:b.icon)||"&#128640;"}}),(f=c.find(a=>a.id===r))==null?void 0:f.title,e.jsx("span",{className:t.mobileNavChevron,children:h?"▲":"▼"})]}),h&&e.jsxs("div",{className:t.mobileNavDropdown,children:[c.map(a=>e.jsxs("button",{onClick:()=>d(a.id),className:r===a.id?t.mobileNavItemActive:t.mobileNavItem,children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:a.icon}}),a.title]},a.id)),e.jsxs("button",{onClick:()=>d("faq"),className:r==="faq"?t.mobileNavItemActive:t.mobileNavItem,children:[e.jsx("span",{children:"❓"})," FAQ"]})]})]}),e.jsxs("div",{className:t.contentWrap,children:[e.jsxs("nav",{className:t.sidebar,children:[c.map(a=>e.jsxs("button",{onClick:()=>d(a.id),className:r===a.id?t.sidebarBtnActive:t.sidebarBtn,children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:a.icon}}),a.title]},a.id)),e.jsxs("button",{onClick:()=>d("faq"),className:r==="faq"?t.sidebarBtnActive:t.sidebarBtn,children:[e.jsx("span",{children:"❓"}),"FAQ"]})]}),e.jsxs("div",{className:t.contentArea,children:[r!=="faq"&&c.filter(a=>a.id===r).map(a=>e.jsxs("div",{children:[e.jsxs("h2",{className:t.sectionTitle,children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:a.icon}}),a.title]}),(a.items||[]).map((o,i)=>{const s=`${a.id}-${i}`,v=p[s]!==!1;return e.jsxs("div",{className:t.docCard,children:[e.jsxs("button",{onClick:()=>g(a.id,i),className:t.docCardHeader,children:[e.jsx("span",{className:t.docCardTitle,children:o.title}),e.jsx("span",{className:v?t.docCardChevronOpen:t.docCardChevron,children:"▼"})]}),v&&e.jsx("div",{className:t.docCardBody,style:{borderTop:"1px solid rgba(255,255,255,0.03)"},children:e.jsx("pre",{className:t.docCardBodyContent,children:o.content})})]},i)})]},a.id)),r==="faq"&&e.jsxs("div",{children:[e.jsxs("h2",{className:t.sectionTitle,children:[e.jsx("span",{children:"❓"}),"Frequently Asked Questions"]}),e.jsxs("div",{className:t.faqSearchWrap,children:[e.jsx("span",{className:t.faqSearchIcon,children:"🔍"}),e.jsx("input",{className:t.faqSearch,type:"text",placeholder:"Search questions...",value:n,onChange:a=>u(a.target.value)}),n&&e.jsx("button",{className:t.faqSearchClear,onClick:()=>u(""),children:"✕"})]}),y.length===0&&e.jsxs("div",{className:t.faqNoResults,children:['No questions found for "',n,'"']}),y.map((a,o)=>{const i=`faq-${o}`,s=p[i]!==!1;return e.jsxs("div",{className:t.docCard,children:[e.jsxs("button",{onClick:()=>g("faq",o),className:t.docCardHeader,children:[e.jsx("span",{className:t.docCardTitle,children:a.q}),e.jsx("span",{className:s?t.docCardChevronOpen:t.docCardChevron,children:"▼"})]}),s&&e.jsx("div",{className:t.docCardBody,style:{borderTop:"1px solid rgba(255,255,255,0.03)"},children:e.jsx("pre",{className:t.docCardBodyContent,children:a.a})})]},o)})]})]})]}),e.jsxs("section",{className:t.ctaSection,children:[e.jsx("h2",{className:t.ctaTitle,children:"Need Help?"}),e.jsx("p",{className:t.ctaSub,children:"Can't find what you're looking for? Reach out to our team."}),e.jsx("a",{href:"mailto:support@auraalpha.cc",className:t.ctaLink,children:"Contact Support"})]}),e.jsx(C,{})]})}export{he as default};
